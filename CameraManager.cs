...
public class CameraManager : MonoBehaviour
{
    ...
    public float minimumCollisionOffset = 0.2f; //The radius of the sphere used for collision
    public float cameraCollisionRadius = 2;
    public float cameraFollowSpeed = 0.2f;
    public float cameraLookSpeed = 2; 
    public float cameraPivotSpeed = 2;

    public float lookAngle; //Camera loojing up and down
    ...
    private void HandleCameraCollisions()
    {
        ...
        if(Physics.SphereCast(cameraPivot.transform.position, cameraCollisionRadius, direction, out hit, Mathf.Abs(defaultPosition),collisionLayers))
        {
